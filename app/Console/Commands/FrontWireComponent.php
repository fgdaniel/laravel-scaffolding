...
class FrontWireComponent extends Command
{
    protected $signature = 'front:wire {name} {--force} {--inline} {--test}';

    protected $description = 'Create a new Frontend Livewire component';

    public function handle()
    {
        $this->parser = new LivewireComponentParser(
            'App\\Http\\Livewire\\Frontend',
            config('livewire.front_view_path'),
			'front',
            $this->argument('name')
        );
