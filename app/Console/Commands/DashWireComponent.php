...
class DashWireComponent extends Command
{
    protected $signature = 'dash:wire {name} {--force} {--inline} {--test}';

    protected $description = 'Create a new Dashboard Livewire component';

    public function handle()
    {
		var_dump(config('livewire.view_path'));
        $this->parser = new LivewireComponentParser(
            'App\\Http\\Livewire\\Dashboard',
			config('livewire.dash_view_path'),
			'dash',
            $this->argument('name')
        );
